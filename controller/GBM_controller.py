...
class SimpleMonitor13(switch.SimpleSwitch13):
    ...
    def flow_training(self):
        ...
        classifier =  GradientBoostingClassifier(n_estimators=10, random_state=0,
                                   max_depth=10,  # Similar to RandomForest max_depth
                                   min_samples_split=2,  # Similar to RandomForest min_samples_split
                                   min_samples_leaf=1,  # Similar to RandomForest min_samples_leaf
                                   max_features='sqrt',  # Similar to RandomForest max_features
                                   learning_rate=0.1,  # Similar learning rate to ensure convergence
                                   subsample=1.0,
                                   verbose=1# Similar to RandomForest, use full sample
                                   )
